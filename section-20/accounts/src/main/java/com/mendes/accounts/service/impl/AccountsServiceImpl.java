...
import com.mendes.accounts.constants.AccountsConstants;
import com.mendes.accounts.dto.AccountsDto;
import com.mendes.accounts.dto.AccountsMessageDto;
...
import com.mendes.accounts.exception.CustomerAlreadyExistsException;
...
public class AccountsServiceImpl  implements IAccountsService {
    ...
    private void sendCommunication(Accounts account, Customer customer) {
        AccountsMessageDto accountMessageDto = new AccountsMessageDto(
    ...
    /**
     * Updates the communication status for the account with the specified account number.
     *
